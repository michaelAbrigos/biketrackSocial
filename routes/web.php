...
Route::group(['middleware' => 'auth'], function() {
	...
	Route::get('nopermssion/peers','PeersController@PeerNo');
	Route::post('/peers/request/addPerm','PeersController@addPerm');
	Route::post('/peers/request/removePerm','PeersController@removePerm');

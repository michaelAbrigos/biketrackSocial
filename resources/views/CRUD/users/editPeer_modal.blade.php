            ...
            <div class="form-group">
              ...
              <div class="form-check form-check-inline">
      	        <label for="message-text" class="col-form-label">Gender: &nbsp</label>
      			  	<input class="form-check-input" checked type="radio" name="inlineRadioOptions" id="gender1-{{$user->id}}" value="male">
      			  	<label class="form-check-label" for="male">Male</label>
      			  </div>

      			  <div class="form-check form-check-inline">
      			  	<input class="form-check-input" type="radio" name="inlineRadioOptions" id="gender2-{{$user->id}}" value="female">
  			    ...
  			    @else
      				...
      				<div class="form-check form-check-inline">
    	          <label for="message-text" class="col-form-label">Gender: &nbsp</label>
    			  	  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="gender1-{{$user->id}}" value="male">
    			  	  <label class="form-check-label" for="male">Male</label>
      			  </div>

      			  <div class="form-check form-check-inline">
      			  	<input class="form-check-input" checked type="radio" name="inlineRadioOptions" id="gender2-{{$user->id}}" value="female">
      				<label class="form-check-label" for="female">Female</label>
      			  </div>

...
<div class="main">
	<div class="row" style="margin-right: 0px !important">
		<div class="col" style="padding-top: 10px; "><h5 class="font-adam">Friend Requests</h5></div>
  	</div>
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6 text-right small-center">
							<button type="button" class="btn btn-raised btn-success">Accept</button>
							<button type="button" class="btn btn-raised btn-danger">Decline</button>
						</div>
					</div>
				</div>	
			</div>

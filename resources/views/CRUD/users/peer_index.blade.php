        ...
        <div class="container mt-2">
            <div class="row">
                <div class="col-12 col-md-9 mb-1 order-md-2 table-responsive mt-3">
                	...
                	<div class="row">
                		<div class="col-md-6"><h5>List of Peers with Permission</h5></div>
                    ...
                    <table class="table table-borderless table-hover align-items-center">
                    	<thead>
                            <tr>
                                ...
                                <th scope="col" class="text-right"><a href="/nopermssion/peers">Show Peers without Permission</a></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                @foreach($users as $user)
                                        <tr class="bg-white">
                                            ...
                                            <td class="text-right"><button type="button" class="btn btn-raised btn-danger removePerm" name="{{$user->id}}">Remove Permission</button>
